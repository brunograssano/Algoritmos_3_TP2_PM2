...
public class CajaTurno extends VBox {
    ...
    private static float ALPHA_CAJA_TURNO = 0.1F;
    ...
    public CajaTurno(TextoTurno textoDelTurno, TextoContadorPreguntas textoContadorPreguntas, String color) {
        ...
        super.setBackground(new Background(new BackgroundFill(Color.web(color, ALPHA_CAJA_TURNO), BORDE_CURVO_CAJA_TURNO,null)));
