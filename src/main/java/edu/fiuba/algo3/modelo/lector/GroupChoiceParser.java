...
public class GroupChoiceParser implements Parser {
    ...
    public Pregunta parse(JSONObject jsPregunta) {
        ...
        ArrayList<RespuestaGrupo> respuestasGrupo1 = new ArrayList<>();
        ArrayList<RespuestaGrupo> respuestasGrupo2 = new ArrayList<>();

        jGrupo1.forEach(jsRespuesta-> respuestasGrupo1.add(new RespuestaGrupo((String) jsRespuesta )));
        jGrupo2.forEach(jsRespuesta-> respuestasGrupo2.add(new RespuestaGrupo((String) jsRespuesta )));
